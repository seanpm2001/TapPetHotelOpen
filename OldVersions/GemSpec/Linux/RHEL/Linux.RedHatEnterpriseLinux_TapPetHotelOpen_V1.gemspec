...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for RHEL (Red Hat Enterprise Linux) (Linux)'
  gem.version       = TapPetHotelOpenRHELinux::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Red Hat Enterprise Linux}
...
# File version: 1 (2022, Sunday, April 24th at 6:00 pm PST)
