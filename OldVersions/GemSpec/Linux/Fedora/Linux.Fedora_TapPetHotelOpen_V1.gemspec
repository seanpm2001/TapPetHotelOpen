...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Fedora Linux'
  gem.version       = TapPetHotelOpenFedoraLinux::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Fedoa Linux}
...
# File version: 1 (2022, Sunday, April 24th at 5:54 pm PST)
