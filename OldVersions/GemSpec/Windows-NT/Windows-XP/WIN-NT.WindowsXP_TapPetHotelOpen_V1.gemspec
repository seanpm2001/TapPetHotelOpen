...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Windows XP (Windows NT)'
  gem.version       = TapPetHotelOpenWindowsXP::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Windows XP (from no service pack to service pack 3)}
...
# File version: 1 (2022, Sunday, April 24th at 6:08 pm PST)
