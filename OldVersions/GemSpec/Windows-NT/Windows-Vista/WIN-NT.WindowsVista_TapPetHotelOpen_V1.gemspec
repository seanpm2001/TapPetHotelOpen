...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Windows Vista (Windows NT)'
  gem.version       = TapPetHotelOpenWindowsVista::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Windows Vista (from no service pack to service pack 2)}
...
# File version: 1 (2022, Sunday, April 24th at 6:11 pm PST)
