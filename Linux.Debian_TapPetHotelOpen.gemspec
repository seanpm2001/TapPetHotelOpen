...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Debian Linux'
  gem.version       = TapPetHotelOpenDebianLinux::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Debian Linux}
...
# File version: 1 (2022, Sunday, April 24th at 5:57 pm PST)
