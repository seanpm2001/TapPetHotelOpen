...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Ubuntu Linux'
  gem.version       = TapPetHotelOpenUbuntu::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Ubuntu Linux}
...
# File version: 1 (2022, Saturday, April 23rd at 8:03 pm PST)
