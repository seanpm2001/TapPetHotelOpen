...
Gem::Specification.new do |gem|
  gem.name          = 'Tap Pet Hotel Open for Mac OS X (10.0 to 10.15) (BSD)'
  gem.version       = TapPetHotelOpenMacOSX::VERSION
  ...
  gem.summary       = %q{The video game "tap pet hotel open" is an open source recreation of the game Tap Pet Hotel by Pocket Gems. Ported to Mac OS X}
...
# File version: 1 (2022, Sunday, April 24th at 6:04 pm PST)
